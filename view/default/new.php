...
<!-- main-sider start -->
			...
			<div class="main-sider">
				<div class="sider-box">
 				...
 				<p>
 					<div class="text-center"><input type="button" value="<?php echo $Lang['CreateOneTag']; ?>" name="CreateOneTag" class="textbtn" onclick="JavaScript:CreateTags();" id="TagPublishButton" /></div>
 					<div class="c"></div>
 				</p>
 			</div>
